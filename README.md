...
Why? Firstly we should be sure that AI write exactly what we need without any explits
...
We strictly check that service use only white hosts like data base host or 3-rd
party allowed hosts and do not do any other requests
